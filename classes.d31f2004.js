...
},{"./models/EmailJSResponseStatus":"../../node_modules/@emailjs/browser/es/models/EmailJSResponseStatus.js","./methods/init/init":"../../node_modules/@emailjs/browser/es/methods/init/init.js","./methods/send/send":"../../node_modules/@emailjs/browser/es/methods/send/send.js","./methods/sendForm/sendForm":"../../node_modules/@emailjs/browser/es/methods/sendForm/sendForm.js"}],"../classes/index.js":[function(require,module,exports) {
"use strict";
...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    this.sendBtn = document.querySelector('.send-message-wrapper');
    this.hamburger = document.querySelector('.hamburger-icon');
    this.close = document.querySelector('.offcanvas-close-icon');
    this.primaryButton = document.querySelectorAll('.primary__btn');
    this.primaryText = document.querySelectorAll('.primary__text');
    this.allMouseOverImages = document.querySelectorAll('img');
    this.allMouseOverText = [].concat(_toConsumableArray(this.primaryButton), _toConsumableArray(this.primaryText));
    this.createRotateTitle();
  ...
  return _createClass(App, [{
    ...
    value: function createIntersectionObserver() {
      var _this = this;
      this.intersects = document.querySelectorAll(".intersect");
      this.observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          _this.intersectImg = _toConsumableArray(entry.target.querySelectorAll('img'));
          _this.intersectTitle = _toConsumableArray(entry.target.querySelectorAll('.intersect-text'));
          _gsap.default.set(_this.intersectTitle, {
            opacity: 0,
            y: 50
          });
          _gsap.default.set(_this.intersectImg, {
            scale: 1.2
          });
          if (entry.isIntersecting) {
            _gsap.default.to(_this.intersectImg, {
              scale: 1,
              clipPath: "inset(0% 0 0% 0)",
              duration: 1,
              ease: "Power4.ease.Out"
            });
            _gsap.default.to(_this.intersectTitle, {
              opacity: 1,
              y: 0,
              duration: 1.5,
              ease: "Expo.ease.Out"
      ...
      this.intersects.forEach(function (targets) {
        _this.observer.observe(targets);
      });
    }
  }, {
    key: "createLocomotiveScroll",
    value: function createLocomotiveScroll() {
      this.locomotiveScroll = new _locomotiveScroll.default({
    ...
    value: function createBarba() {
      ...
      _core.default.hooks.before(function () {
        _this2.locomotiveScroll.destroy();
      });
      _core.default.hooks.after(function () {
        _this2.primaryButton = document.querySelectorAll('.primary__btn');
        _this2.sendBtn = document.querySelector('.send-message-wrapper');
        _this2.primaryText = document.querySelectorAll('.primary__text');
        _this2.allMouseOverText = [].concat(_toConsumableArray(_this2.primaryButton), _toConsumableArray(_this2.primaryText));
        _this2.close = document.querySelector('.offcanvas-close-icon');
        _this2.hamburger = document.querySelector('.hamburger-icon');
        _this2.allMouseOverImages = document.querySelectorAll('img');
        _this2.createIntersectionObserver();
        _this2.createRotateTitle();
        _this2.onEmailInit();
        _this2.addEventListeners();
        _this2.locomotiveScroll.init();
      });
    }
  }, {
    key: "createRotateTitle",
    value: function createRotateTitle() {
      this.tiltes = _toConsumableArray(document.querySelectorAll(".rotate__title"));
      this.tiltes.forEach(function (item) {
        var word = item.children[0].children[0].innerText.split('');
        item.children[0].innerHTML = '';
        word.forEach(function (letter, idx) {
          item.children[0].innerHTML += "<span style=\"--index:".concat(idx, ";\">").concat(letter, "</span>");
        });
        var cloneDiv = item.children[0].cloneNode(true);
    ...
    key: "onEmailInit",
    value: function onEmailInit() {
      _browser.default.init({
        publicKey: 'COvvDfNuYoDeRJRsK'
      });
    }
  }, {
    key: "onEmailSend",
    value: function onEmailSend() {
      this.emailParams = {
        from_name: document.querySelector('form #name').value,
        email_id: document.querySelector('form #email').value,
        phone_id: document.querySelector('form #phone').value,
        subject: document.querySelector('form #subject').value,
        message: document.querySelector('form #message').value
      };
      _browser.default.send('service_dlgsyyz', 'template_eaysstm', this.emailParams).then(console.warn('message have been send'));
    }
  }, {
    key: "onMouseOverText",
    value: function onMouseOverText(e) {
      this.PTL = _gsap.default.timeline({
        paused: true
      });
      if (e.target) {
        this.PTL.to(e.target, {
          '--after': '0%',
          duration: 0.3,
          ease: "Power0.easeIn"
        });
    ...
    key: "createCanvasOpen",
    value: function createCanvasOpen() {
      this.CTL = _gsap.default.timeline({
        paused: true
      });
      this.CTL.to('.offcanvas-menu', {
        height: '100vh',
        duration: 1.2,
        ease: "Expo.easeInOut"
      });
      this.CTL.fromTo('.offcanvas-navlink-item', {
        x: -10,
        opacity: 0
      }, {
        x: 0,
    ...
    key: "createCanvasClose",
    value: function createCanvasClose() {
      this.CTL.reverse();
    }
  }, {
    key: "onMouseOverImages",
    value: function onMouseOverImages(e) {
      _gsap.default.to(e.target, {
        clipPath: "inset(1%)",
        duration: 0.3,
        ease: "Expo.ease.in"
      });
    ...
    key: "onMouseOutImages",
    value: function onMouseOutImages(e) {
      _gsap.default.to(e.target, {
        clipPath: "inset(0%)",
        duration: 0.3,
        ease: "Expo.ease.Out"
    ...
    value: function addEventListeners() {
      var _this3 = this;
      this.allMouseOverText.forEach(function (element) {
        element.addEventListener('mouseover', _this3.onMouseOverText.bind(_this3));
      });
      this.allMouseOverImages.forEach(function (t) {
        t.addEventListener('mouseover', _this3.onMouseOverImages.bind(_this3));
      });
      this.allMouseOverImages.forEach(function (o) {
        o.addEventListener('mouseout', _this3.onMouseOutImages.bind(_this3));
      });
      if (this.sendBtn) {
      ...
      this.hamburger.addEventListener('click', this.createCanvasOpen.bind(this));
      this.close.addEventListener('click', this.createCanvasClose.bind(this));
    }
  }]);
}();
new App();
},{"@barba/core":"../../node_modules/@barba/core/dist/barba.umd.js","gsap":"../../node_modules/gsap/index.js","locomotive-scroll":"../../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","@emailjs/browser":"../../node_modules/@emailjs/browser/es/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
